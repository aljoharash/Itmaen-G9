          ...
          body: FutureBuilder(
            ...
            builder: (ctx, snapshot) {
              ...
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                backgroundColor: ui.Color.fromARGB(255, 119, 122, 122),  
                valueColor: new AlwaysStoppedAnimation<Color>(ui.Color.fromARGB(255, 54, 244, 130)),  
                value: 0.5,  
              ),
               SizedBox(
              ...
              Center(
             child: Text('${(0.1* 100).round()}%',style: GoogleFonts.tajawal(
                                        fontWeight: FontWeight.bold)),),
                                    ...
                                    Container(
                                      ...
                                      children: [
                                        ...
                                        MaterialButton(
                                          ...
                                          color: ui.Color.fromARGB(255, 183, 221, 243),
