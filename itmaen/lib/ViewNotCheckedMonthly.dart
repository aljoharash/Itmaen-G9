...
class ViewNotAllCheckMonthly extends StatefulWidget {
  const ViewNotAllCheckMonthly({Key? key}) : super(key: key);

  @override
  _ViewNotAllCheckMonthlyPageState createState() => _ViewNotAllCheckMonthlyPageState();
}

class _ViewNotAllCheckMonthlyPageState extends State<ViewNotAllCheckMonthly> {
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              for (var med in medicines) {
                               ...
                               if(y==false && today.difference(m.toDate()).inDays <= 30){
                                counter2++; 

                               }
                                if (checked == false && y==false && today.difference(m.toDate()).inDays <= 30) {
                                  counter++;
