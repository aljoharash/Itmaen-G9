...
class ViewNotAllCheckWeekly extends StatefulWidget {
  const ViewNotAllCheckWeekly({Key? key}) : super(key: key);

  @override
  _ViewNotAllCheckWeeklyPageState createState() => _ViewNotAllCheckWeeklyPageState();
}

class _ViewNotAllCheckWeeklyPageState extends State<ViewNotAllCheckWeekly> {
                        ...
                        StreamBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              for (var med in medicines) {
                               ...
                               if(y==false && today.difference(m.toDate()).inDays <= 7){
                                counter2++; 

                               }
                                if (checked == false && y==false && today.difference(m.toDate()).inDays <= 7) {
                                  counter++;
