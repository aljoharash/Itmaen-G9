...
class ViewAllCheckWeekly extends StatefulWidget {
  const ViewAllCheckWeekly({Key? key}) : super(key: key);

  @override
  _ViewAllCheckWeeklyPageState createState() => _ViewAllCheckWeeklyPageState();
}

class _ViewAllCheckWeeklyPageState extends State<ViewAllCheckWeekly> {
                            ...
                            builder: (BuildContext context,
                              ...
                              for (var med in medicines) {
                               ...
                               counter2 ++ ; 
                                ...
                                if (checked == true && y==false && today.difference(m.toDate()).inDays <= 7) {
                                  counter++; 
