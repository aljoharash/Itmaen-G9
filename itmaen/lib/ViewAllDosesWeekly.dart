...
class ViewAllWeekly extends StatefulWidget {
  const ViewAllWeekly({Key? key}) : super(key: key);

  @override
  _ViewAllWeeklyPageState createState() => _ViewAllWeeklyPageState();
}

class _ViewAllWeeklyPageState extends State<ViewAllWeekly> {
