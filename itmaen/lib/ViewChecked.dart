...
class ViewAllCheck extends StatefulWidget {
  const ViewAllCheck({Key? key}) : super(key: key);

  @override
  _ViewAllCheckPageState createState() => _ViewAllCheckPageState();
}

class _ViewAllCheckPageState extends State<ViewAllCheck> {
