                                          ...
                                          widget.checked
                                              ? ((widget.timechecked.toDate())
                                                  ...
                                                  : (((widget.timechecked
                                                          ...
                                                          60)
                                                      ? Text(
                                                          '  تم أخذ الدواء  قبل الموعد ب ${((widget.timechecked.toDate()).difference(widget.m.toDate())).abs().inHours}     ساعات :) ' +
                                                              '\n',
                                                          style: GoogleFonts
                                                              .tajawal(
                                                                  fontSize: 10,
                                                      ...
                                                      : Text(
                                                          '  تم أخذ الدواء  قبل الموعد ب ${((widget.timechecked.toDate()).difference(widget.m.toDate())).abs().inMinutes} دقائق :) ' +
                                                              '\n',
                                                          style: GoogleFonts
                                                              .tajawal(
                                                                  fontSize: 10,
