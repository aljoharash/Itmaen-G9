...
class ViewNotAllCheckDaily extends StatefulWidget {
  const ViewNotAllCheckDaily({Key? key}) : super(key: key);

  @override
  _ViewNotAllCheckDailyPageState createState() => _ViewNotAllCheckDailyPageState();
}

class _ViewNotAllCheckDailyPageState extends State<ViewNotAllCheckDaily> {
                            ...
                            builder: (BuildContext context,
                              ...
                              for (var med in medicines) {
                               ...
                               if(y==false && today.difference(m.toDate()).inDays <= 1){
                                ...
                                if (checked == false && y==false && today.difference(m.toDate()).inDays <= 1 ) {
                                  counter++;
