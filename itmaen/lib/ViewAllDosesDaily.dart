...
class ViewAllDaily extends StatefulWidget {
  const ViewAllDaily({Key? key}) : super(key: key);

  @override
  _ViewAllDailyPageState createState() => _ViewAllDailyPageState();
}

class _ViewAllDailyPageState extends State<ViewAllDaily> {
