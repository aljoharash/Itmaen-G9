...
class ViewAllCheckMonthly extends StatefulWidget {
  const ViewAllCheckMonthly ({Key? key}) : super(key: key);

  @override
  _ViewAllCheckMonthlyPageState createState() => _ViewAllCheckMonthlyPageState();
}

class _ViewAllCheckMonthlyPageState extends State<ViewAllCheckMonthly > {
                            ...
                            builder: (BuildContext context,
                              ...
                              for (var med in medicines) {
                               ...
                               counter2 ++ ; 
                                ...
                                if (checked == true && y==false && today.difference(m.toDate()).inDays <= 30 ) {
                                  counter++; 
